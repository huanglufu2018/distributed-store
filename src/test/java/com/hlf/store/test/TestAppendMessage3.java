...
public class TestAppendMessage3 {

    // 添加500000 条消息总耗时：1605
    public static void main(String[] args) {
        try {
            UnMappedFile2 unMappedFile2 = new UnMappedFile2("F:\\storetest\\0", 1024 * 1024 * 1024);
            ...
            for (int i = 0; i < msgSize; i++) {
                AppendMessageResult result = unMappedFile2.appendMessagesInner(message);
