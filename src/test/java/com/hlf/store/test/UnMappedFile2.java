...
public class UnMappedFile2 {
     ...
     * @throws IOException
     */
    public UnMappedFile2(String fileName, int fileSize) throws IOException {
    ...
    public AppendMessageResult doAppend(long fileFromOffset, int maxBlank, MessageExtBrokerInner msgInner) throws IOException {
        ...
        long wroteOffset = fileFromOffset + this.wrotePosition.get();
        ...
        // 物理偏移量
        this.msgStoreItemMemory.putLong(fileFromOffset + this.wrotePosition.get());
        ...
        fos.write(this.msgStoreItemMemory.array(), 0 , msgLength);
